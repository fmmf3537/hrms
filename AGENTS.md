...
- ⏳ **M5 联调上线（第 16-18 周，进行中）**：M5-1 Nginx+Docker ✅ → M5-2 前端（0 基础设施 ✅ / A1 ✅ / A2 ✅ / B 考勤 ✅ / **C1 薪酬基础配置 ✅**（薪级薪档+方案+社保公积金+个税工具，22 端点，56/56 前端测试），C2 算薪与工资条 / C3 提成·预警·调薪 / D 绩效待做）→ M5-01~08 联调任务（接口联调 / E2E / 数据迁移 / 渗透 / 压测 / 培训 / 并行核算 / 上线）
