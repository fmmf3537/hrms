...
| 10113 | 401 | TOKEN_REVOKED | Access token 已失效（改密/强制改密/账号停用后旧 token，M5-04 新增 DB tokenVersion 校验） | 清空登录态，重新登录 |
...
| 10131 | 401 | TWO_FACTOR_LOCKED | 2FA 验证码错误超 5 次，30 分钟内锁定（M5-04 新增尝试计数） | 提示 30 分钟后再试 |
...
| 1xxxx 认证 | 10100-10113 + 10120-10121 + 10130-10131（13 个）| 10122-10129 + 10132-10199 | 13 | 已实现（含 rotation/reuse + 必须改密 + 二次验证 + M5-04 tokenVersion 校验/2FA 锁定） |
